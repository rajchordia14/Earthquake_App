...
public final class QueryUtils {
    ...
    /**
     * Create a private TextView magnitudeview =(TextView) listItemView.findViewById(R.id.magnitude);

        magnitudeview.setText(currentEarthquake.getMagnitude()); constructor because no one should ever create a {@link QueryUtils} object.
